...
describe("Single Bin Seed Liquidity Test", () => {
    describe("TokenX decimals < TokenY decimals", () => {
        ...
        beforeAll(async () => {
            ...
            owner.publicKey, activationPoint, false, {
                cluster: "localhost",
            });
        ...
        it("seed liquidity single bin", async () => {
            const ixs = await pair.seedLiquiditySingleBin(owner.publicKey, baseKeypair.publicKey, wenSeedAmount, initialPrice, true, positionOwnerKeypair.publicKey, feeOwnerKeypair.publicKey, owner.publicKey, new anchor_1.BN(0), true);
