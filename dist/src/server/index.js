...
app.use(async function (req, res, next) {
    ...
    req.pool = new web3_js_1.PublicKey("3amFSaAuShi4q7597yr8hvGC44Nck9zvGaT3HPToWHJq");
...
app.post("/dlmm/stake", async (req, res) => {
    const dlmmPool = await dlmm_1.DLMM.create(req.connect, req.pool, {
        cluster: "devnet",
    });
    const activeBin = await (0, example_1.getActiveBin)(dlmmPool);
...
app.post("/dlmm/create-customizable-permissionless-lb-pair", async (req, res) => {
    try {
        ...
        const activationPoint = req.body.activationPoint !== null
            ? new bn_js_1.BN(req.body.activationPoint)
            : null;
