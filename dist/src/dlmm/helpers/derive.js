...
exports.derivePresetParameterWithIndex = derivePresetParameterWithIndex;
exports.deriveLbPairWithPresetParamWithIndexKey = deriveLbPairWithPresetParamWithIndexKey;
...
exports.deriveTokenBadge = deriveTokenBadge;
exports.deriveEventAuthority = deriveEventAuthority;
exports.deriveRewardVault = deriveRewardVault;
...
function deriveLbPairWithPresetParamWithIndexKey(presetParameterKey, tokenX, tokenY, programId) {
    ...
    return web3_js_1.PublicKey.findProgramAddressSync([presetParameterKey.toBuffer(), minKey.toBuffer(), maxKey.toBuffer()], programId);
}
/**
 *
...
function deriveTokenBadge(mint, programId) {
    return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("token_badge"), mint.toBuffer()], programId);
}
...
function deriveRewardVault(lbPair, rewardIndex, programId) {
    return web3_js_1.PublicKey.findProgramAddressSync([lbPair.toBuffer(), rewardIndex.toArrayLike(Buffer, "le", 8)], programId);
}
