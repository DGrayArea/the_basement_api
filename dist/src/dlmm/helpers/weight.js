...
function fromWeightDistributionToAmountOneSide(amount, distributions, binStep, activeId, depositForY, mint, clock) {
    if (depositForY) {
        return (0, weightToAmounts_1.toAmountBidSide)(activeId, amount, distributions, mint, clock);
    }
    else {
        return (0, weightToAmounts_1.toAmountAskSide)(activeId, binStep, amount, distributions, mint, clock);
    }
}
/**
...
function fromWeightDistributionToAmount(amountX, amountY, distributions, binStep, activeId, amountXInActiveBin, amountYInActiveBin, mintX, mintY, clock) {
    ...
    if (activeId > distributions[distributions.length - 1].binId) {
        let amounts = (0, weightToAmounts_1.toAmountBidSide)(activeId, amountY, distributions, mintY, clock);
    ...
    if (activeId < distributions[0].binId) {
        let amounts = (0, weightToAmounts_1.toAmountAskSide)(activeId, binStep, amountX, distributions, mintX, clock);
        return amounts.map((bin) => {
            return {
                binId: bin.binId,
    ...
    return (0, weightToAmounts_1.toAmountBothSide)(activeId, binStep, amountX, amountY, amountXInActiveBin, amountYInActiveBin, distributions, mintX, mintY, clock);
}
